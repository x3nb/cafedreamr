...
/* ------------------------------------------------------------
   ...
   hans takes the room at 13:00). the class is always walkable;
   `time` is shown in the picker so a player who arrives early
   knows when the room fills.
   ------------------------------------------------------------ */
etiquette: {
  title: "etiquette",
  spoken: "etiquette",
  blurb: "the tea academy \u00b7 13:00",
  time: "13:00",
  host: "hans",
  ...
  nodes: {
    ...
    open: {
      who: "hans",
      say: "{name}. good. sit anywhere — not there, that is where the cat adjudicates. first lesson, and it is the only one that matters: nobody is bad at manners. they are only ever in a hurry. we are going to remove the hurry.",
    ...
    cupBoth: {
      who: "hans",
      say: "correct, and not for the reason you think. both hands says: i am not leaving yet. the cup is only an excuse to stay in the room, and it is the best one anyone has invented.",
      next: "chair"
    },
    cupHandle: {
      who: "hans",
    ...
    cupHonest: {
      who: "hans",
      say: "then you are teachable, which is worth more than polite. polite people stop listening the moment they become good at it.",
    ...
    chairPush: {
      who: "hans",
      say: "yes. and it is not about the chair. it is the two seconds in which you consider whoever comes next. almost nobody spends them.",
      next: "noticing"
    },
    chairLeave: {
      who: "hans",
