...
/* ------------------------------------------------------------
   ...
   the hour — the academy does not keep a wall-clock hour any
   more. hans sets one for whoever asks: twenty minutes, and no
   more. `beginsIn` says how many minutes he asks for; the runner
   writes the time down for this browser (the same localStorage
   key HANS/index.html writes — cd_class_at_etiquette), counts
   down to it by the second, and opens the room when it comes,
   keeping it open for `windowMin`. nobody is asked to wait seven
   hours for a cup of tea. hans is still precise; so is the door.
   ------------------------------------------------------------ */
etiquette: {
  title: "etiquette",
  spoken: "etiquette",
  blurb: "the tea academy \u00b7 twenty minutes, sharp",
  beginsIn: 20,
  windowMin: 120,
  host: "hans",
  ...
  away: {
    ...
    lines: "hans sets the hour when he asks \u2014 twenty minutes, and not one more. the kettle is on, the chairs are straight, and not one of them has been sat in yet. he will know if you are late, and he will pretend he did not notice."
  },
