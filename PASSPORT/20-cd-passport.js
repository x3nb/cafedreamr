...
var RULES = [
  ...
  { pre: "intake:",  p: 8,  label: "sat the café's interview",   group: "the cafe",       accent: "#c0a6ff" },
  { pre: "glitter:", p: 6, label: "the glitter bomb went off",     group: "the games room", accent: "#ccff00" },
  { pre: "drop:clean", p: 4, label: "and out clean",               group: "the games room", accent: "#00e5ff" },
  { pre: "drop:",    p: 6, label: "miki planted the glitter bomb",  group: "the games room", accent: "#ccff00" },
...
var PAGES = {
  ...
  invitation: "an interview",
  glitterbomb: "the glitter bomb",
  glitterdrop: "the glitter drop"
};
